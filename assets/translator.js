var i18n_data = {
    'zh': {
        ...
        'instruction1': '请直接选择你的长毛象存档文件，它的格式应该是 <b><code>archive-xxx.tar.gz</code></b>. 但如果你的实例版本大于 4.2，它的格式应该是 <b><code>archive-xxx.zip</code></b>.',
    ...
    'en': {
        ...
        'instruction1': 'Choose and open directly the archive file, its file name format should be like <b><code>archive-xxx.tar.gz</code></b>. But if the version of your instance is newer than 4.2, it should be like <b><code>archive-xxx.zip</code></b>.',
